...
public:
  ...
  Histogram(const Coordinate& min = Coordinate::Zero(), const Coordinate& max =
    Coordinate::Ones(), const Coordinate& binSize = Coordinate::Ones());
  /// Copy constructor
...
#include "statistics/HistogramMv.tpp"
